...
const HeroSecSix = () => {
  const cardData = [
    { imgSrc: img, title: 'খাদ্য ও পুষ্টি', button: 'অংশগ্রহণ' },
    { imgSrc: img, title: 'স্বাস্থ্যসম্মত জীবনধারা', button: 'অংশগ্রহণ' },
    { imgSrc: img, title: 'মানসিক স্বাস্থ্য', button: 'অংশগ্রহণ' },
    { imgSrc: img, title: 'নেতৃত্ব', button: 'অংশগ্রহণ' },
    { imgSrc: img, title: 'সামাজিক ক্ষেত্র', button: 'অংশগ্রহণ' },
